...
from formula.api.serializers import RecipeSerializer, RecipeDetailSerializer


RECIPES_URL = reverse('formula:recipe-list')


def detail_url(recipe_id):
    """Create and return a recipe detail URL."""
    return reverse('formula:recipe-detail', args=[recipe_id])


def image_upload_url(recipe_id):
    """Create and return an image upload URL."""
    return reverse('formula:recipe-upload-image', args=[recipe_id])
